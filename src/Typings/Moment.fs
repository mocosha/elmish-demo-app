...
let [<Import("*","moment")>] moment: Moment.IExports = jsNative

type [<AllowNullLiteral>] IExports =
    abstract moment: ?inp: Moment.MomentInput * ?format: Moment.MomentFormatSpecification * ?strict: bool -> Moment.Moment
    abstract moment: ?inp: Moment.MomentInput * ?format: Moment.MomentFormatSpecification * ?language: string * ?strict: bool -> Moment.Moment
