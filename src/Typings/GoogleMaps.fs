...
module Google =
    let [<Import("maps","googlemaps/google")>] maps: Maps.IExports = jsNative

    module Maps =
        let [<Import("adsense","googlemaps/google/maps")>] adsense: Adsense.IExports = jsNative
        let [<Import("Data","googlemaps/google/maps")>] data: Data.IExports = jsNative
        let [<Import("drawing","googlemaps/google/maps")>] drawing: Drawing.IExports = jsNative
        let [<Import("geometry","googlemaps/google/maps")>] geometry: Geometry.IExports = jsNative
        let [<Import("places","googlemaps/google/maps")>] places: Places.IExports = jsNative
        let [<Import("visualization","googlemaps/google/maps")>] visualization: Visualization.IExports = jsNative
        ...
        type [<AllowNullLiteral>] Map =
            inherit MVCObject
            abstract fitBounds: bounds: U2<LatLngBounds, LatLngBoundsLiteral> * ?padding: float -> unit
            ...
            abstract panToBounds: latLngBounds: U2<LatLngBounds, LatLngBoundsLiteral> -> unit
        ...
        type [<AllowNullLiteral>] eventStatic =
            ...
            abstract addDomListener: instance: Object * eventName: string * handler: Function * ?capture: bool -> MapsEventListener
            /// Wrapper around addDomListener that removes the listener after the first event.
            abstract addDomListenerOnce: instance: Object * eventName: string * handler: Function * ?capture: bool -> MapsEventListener
            ...
            /// removeListener().
            abstract addListener: instance: Object * eventName: string * handler: Function -> MapsEventListener
            /// Like addListener, but the handler removes itself after handling the first event.
            abstract addListenerOnce: instance: Object * eventName: string * handler: Function -> MapsEventListener
        ...
        type [<AllowNullLiteral>] LatLngStatic =
            ...
            /// <param name="lng">Longitude is specified in degrees within the range [-180, 180].</param>
